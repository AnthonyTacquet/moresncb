...
public class FavoriteAdapter extends ArrayAdapter<Connection> {
    private LayoutInflater inflater;
    private Context context;
    private Memory memory;
    private ArrayList<Connection> favorites;

    public FavoriteAdapter(Context context, List<Connection> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.fromLabel = convertView.findViewById(R.id.from_label);
            viewHolder.toLabel = convertView.findViewById(R.id.to_label);
        ...
        viewHolder.fromLabel.setText(item.getDeparture().getStationName());
        viewHolder.toLabel.setText(item.getArrival().getStationName());
    ...
    private static class ViewHolder {
        ...
        TextView departureDelay, fromLabel, toLabel;
