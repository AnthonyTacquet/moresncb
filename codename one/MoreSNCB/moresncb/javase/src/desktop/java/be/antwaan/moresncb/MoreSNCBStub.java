 ...
 * @author Shai Almog
 */
public class MoreSNCBStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MoreSNCB";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MoreSNCBStub());
    }
